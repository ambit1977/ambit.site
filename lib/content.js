export const content = {
  hero: {
    ...
    body: [
      '独立コンサルタント・秋山大志が、AI時代のマーケティング・データ活用を上流の戦略から実装まで一人称で伴走します。',
    ...
    pillars: [
      ...
      },
      {
        number: '02',
        title: '5領域を貫く実装力',
        description: 'ガバナンス・アナリティクス・アドテク・MA/CRMの全領域を、戦略から実装まで自分の手で触れる。だからこそAIで「どこに何を自動化するか」を一気通貫で設計できます。',
      },
      {
        number: '03',
        title: 'Principal が直接担当する密度と独立性',
        description: '代理店やベンダーのように下請けへ流さず、Principal(主席)である秋山大志本人が、戦略立案から実装レビューまで責任を持って担当。媒体・ツールに忖度しない、独立した立場での判断を提供します。',
      },
    ],
  ...
  about: {
    ...
    role: 'AMBIT 代表 / Principal Consultant',
    catchphrase: 'AI時代のAI活用、その第一人者として。',
    // プロフィール写真
    photo: '/profile.jpg',
    bio: [
      'データガバナンス、WEBアナリティクス、アドテク、MA/CRM ── マーケティング・データ活用の上流から実装までを横断してきた、ハンズオン型の独立系プリンシパル・コンサルタント。',
      '生成AIが事業を書き換え始めた今、これら全領域を「AIでどう再設計するか」を起点に、戦略立案からツール選定、実装、運用までをPrincipal自身が一気通貫で担当します。',
      '代理店でもツールベンダーでもない独立した第三者として、媒体・製品に忖度しない判断を提供します。',
    ],
    credentials: [
      { label: '専門領域', value: 'AI活用 / データガバナンス / WEBアナリティクス / アドテク / MA・CRM' },
      { label: 'スタイル', value: '戦略から実装までPrincipalが直接担当 / 顧問・プロジェクト・フラクショナル' },
      { label: '対応規模', value: '年商10億〜500億円規模の事業会社を中心に' },
    ],
    // 経歴ハイライト。空配列ならセクション非表示
    // 形式: { period, role, org, note? }
    experience: [
      { period: '2022 ─', role: 'AMBIT 代表 / Principal Consultant', org: 'AMBIT', note: 'AI活用を軸に、データ・マーケ全領域のコンサルティングを独立して提供' },
  ...
  contact: {
    ...
    methods: [
      {
        label: 'Email',
        value: 'ambit.akiyama@ezmag.net',
        href: 'mailto:ambit.akiyama@ezmag.net',
        note: '最も確実な連絡手段です',
      },
    ],
    fields: [
