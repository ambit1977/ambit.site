  ...
  return (
    <section id="hero" className="pt-[110px] md:pt-[180px] pb-[80px] md:pb-[160px] border-b border-hair">
      <div className="max-w-[1240px] mx-auto px-5 md:px-8">
        <div className="reveal d1 mb-10 md:mb-20">
          <span className="divider-label">CASE 2 / Text-Focused</span>
        </div>

        <div className="reveal d2 mb-8 md:mb-12 max-w-[800px]">
          <h1 className="text-[40px] md:text-[64px] lg:text-[88px] leading-[1.05] md:leading-[0.95] tracking-display font-semibold">
            {hero.tagline.split('\n').map((line, i) => (
              <span key={i}>
        ...
        <div className="reveal d3 mb-14 md:mb-24 max-w-[700px]">
          <p className="font-jp text-[18px] md:text-[22px] lg:text-[28px] leading-[1.5] font-medium">
            {hero.subheading}
          </p>
        </div>

        <div className="reveal d4 max-w-[640px] mb-12 md:mb-20">
          {hero.body.map((paragraph, i) => (
            <p key={i} className="font-jp text-[15px] md:text-[16px] leading-[1.9] text-sub" style={{marginTop: i > 0 ? '1.5rem' : 0}}>
              {paragraph}
            </p>
          ))}
        </div>

        <div className="reveal d5 space-y-10 md:space-y-12 mb-16 md:mb-24 max-w-[560px]">
          {hero.pillars.map((pillar) => (
            <div key={pillar.number}>
              ...
              <h3 className="font-jp text-[17px] md:text-[18px] font-semibold mb-2">
                {pillar.title}
              </h3>
